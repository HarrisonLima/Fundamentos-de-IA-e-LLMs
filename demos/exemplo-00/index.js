...
async function trainModel(inputXs, outputYs) {
  ...
  // 80 neurônios = quantidade alta por ter pouca base de treino
  ...
  // Se for zero ou negativa, pode jogar fora,nãovai servir
  model.add(
  ...
  // epochs: quantiadde de vezes que vai rodar no dataset
  // shuffle: embaralha os dadosm para evitar viés
...
// Criamos tensores de entrada (xs) e saída (ys) para treinar o
//  modelo
